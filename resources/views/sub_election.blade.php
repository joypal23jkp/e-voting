...
@section('content')
    <main>
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-7 col-md-12">
                                <div class="hero__caption">
                                    <h1 data-animation="fadeInLeft" data-delay="0.2s">Get Related<br>Sub Elections</h1>
        ...
        <section class="container my-5">
            @foreach($sub_elections as $election)
                <div class="card text-center my-5" style="font-family: 'Nunito', sans-serif;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('election.profile', ['pre_con' => 'sub_election', 'id' => $election->id]) }}" class="btn btn-primary">Visit</a>
                    </div>
                </div>
                <hr>
            @endforeach
