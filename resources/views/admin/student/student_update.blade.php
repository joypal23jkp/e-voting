                        ...
                        <div>
                            <form method="POST" action="{{ route('admin.student.update') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="birth_date" type="date" class="form-control @error('birth_date') is-invalid @enderror" name="birth_date" value="{{ $user->date_of_birth }}" required autocomplete="birth_date">
